...
sed_use = sed[np.sum(np.isnan(sed.values), axis=1) == 2]
...
for n in names_use:
    ...
    fig_fit.savefig('casey_bayes_results/wturn_fixed50_beta_fixed1_8/sed_plots/' + n +
                    '_casey_bayes_wturn_fixed50_sed_fit.png',
                    bbox_inches='tight')
    plt.close(fig_fit)
    fig_triangle = bat_plot.plot_triangle(model_final)
    fig_triangle.savefig('casey_bayes_results/wturn_fixed50_beta_fixed1_8/triangle_plots/' + n +
    ...
    fit_dict = {'name': n,
                ...
                'filters': filt_use,
                'waves': waves}
    pickle_file = open('casey_bayes_results/wturn_fixed50_beta_fixed1_8/pickles/' + n +
