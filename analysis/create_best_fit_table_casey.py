...
files = glob(dir_sed+'analysis/casey_bayes_results/beta_fixed_2_wturn_gaussianPrior/pickles/*')
...
df.to_csv(dir_sed+'analysis/casey_bayes_results/beta_fixed_2_wturn_gaussianPrior/final_fit_results_beta_fixed_2_wturn_gaussianPrior.csv',
          index_label='Name')